...
public class PatchouliItems {
	...
	private static void registerRecipeSerializers() {
		Registry.register(Registry.RECIPE_SERIALIZER, new ResourceLocation(PatchouliAPI.MOD_ID, "shaped_book_recipe"), ShapedBookRecipe.SERIALIZER);
		Registry.register(Registry.RECIPE_SERIALIZER, new ResourceLocation(PatchouliAPI.MOD_ID, "shapeless_book_recipe"), ShapelessBookRecipe.SERIALIZER);
	}
}
