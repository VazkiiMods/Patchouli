...
public class ComponentIngredient extends TemplateComponent {
	...
	public void build(BookPage page, BookEntry entry, int pageNum) {
		ingredient = ItemStackUtil.loadIngredientFromString(ingredientString);
	}
	...
	public void render(BookPage page, int mouseX, int mouseY, float pticks) {
		...
		page.renderIngredient(x, y, mouseX, mouseY, ingredient);
	}
